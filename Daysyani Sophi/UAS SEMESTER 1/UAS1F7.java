...
public class UAS1F7 {
    public static void main(String[] args) {
        ...
        String dataTim7 [][] = new String[jumlahTim7][3]; // array 2 dimensi untuk menyimpan nama tim, skor level 1 2
        int totalSkor7 [] = new int[jumlahTim7]; //array untuk menyimpan total skor setiap tim
        boolean dataTerisi7 = false; //menandai data tim
            ...
            switch (pilihan) {
                case 1:
                    for (int i = 0; i < jumlahTim7; i++) {
                        ...
                        //menambahkan bonus buff 7 kemenangan berturut turut lebih dari 50
    ...
    private static void tentukanJuara(String[][] dataTim, int[] totalSkor) {
        ...
        if (seri) {
            System.out.println("Turnamen berakhir seri. Tim terbaik adalah.");
        } else {
