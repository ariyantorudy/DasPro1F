...
public class ModifikasiCafe01 {
    ...
    public static void main(String[] args) {
        ...
        if (totalHarga > 100000) {
            // Jika total lebih dari 100.000, beri diskon tambahan (5%)
            totalHarga -= totalHarga * diskonTambah;
        }
        ...
        // Hanya berikan diskon 10% jika pelanggan adalah member
        if (keanggotaan) {
